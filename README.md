...
This repository contains structured system design lessons and case studies for learning key concepts used in technical interviews and real-world architecture.

## Folder structure

- `Lesson_1_Introduction.md` to `Lesson_16.md`: core system design topics, increasing complexity
- `Advance-System-Design/`: deeper concepts for advanced topics
- `Case-Studies/`: practical real-world scenario design walkthroughs
